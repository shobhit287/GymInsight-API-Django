...
emailTemplateConfigs = {
    ...
    "UPDATED_DOCUMENT_APPROVAL_REJECT": os.path.join(settings.BASE_DIR, "emailService", "updated-document-approval-reject.html"),
    "DOCUMENT_APPROVAL": os.path.join(settings.BASE_DIR, "emailService", "document-approve.html"),
    "DOCUMENT_REJECTED": os.path.join(settings.BASE_DIR, "emailService", "document-reject.html"),
}